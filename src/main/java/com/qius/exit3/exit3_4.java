 ...
 * 可以交换两个Integer对象的内容吗？
 */
public class exit3_4 {
    public static void main(String[] args) {
        System.out.println("问题4：Java中交换变量值的机制分析");
        System.out.println("----------------------------------");
        ...
        System.out.println("2. 可变对象（如AtomicInteger）可以通过方法交换内容，因为可以修改对象状态");
        System.out.println("3. 不可变对象（如Integer）不能交换内容，因为其状态不能修改");
        System.out.println("4. 如果要交换两个int值，可以：");
        System.out.println("   - 使用包装类如AtomicInteger");
    ...
    /**
     * 以下是一个自定义的IntHolder类，类似于Java中的IntHolder
